package dbjdbctres;
import dbpgjdbcdos.DbConsultar;

import java.sql.*;
import java.util.ArrayList;

public class DbOperaciones {
    public static void insertarLibros(DataModelLibros dataModelLibros){
        try{
            /*
     ...
     */
            ...
            preparedStatement.setString(1, dataModelLibros.getTituloLibro());
            preparedStatement.setString(2, dataModelLibros.getEditorialLibro());
            preparedStatement.setInt(3,dataModelLibros.getAutorId());
    ...
    public static void insercionMultiple(ArrayList<DataModelLibros> libros){
       /*
        ...
        */
        try{
            ...
            PreparedStatement preparedStatement = connection.prepareStatement(DbQuerys.SQL);
            int contador = 0;
            for (DataModelLibros dataModelLibros : libros){
                preparedStatement.setString(1, dataModelLibros.getTituloLibro());
                preparedStatement.setString(2, dataModelLibros.getEditorialLibro());
                preparedStatement.setInt(3,dataModelLibros.getAutorId());
    ...
    public static int actualizarElementos(DataModelLibros dataModelLibros){
        int fila = 0;
        try{
            Connection connection = DbConection.abrirConexion();
            ...
            preparedStatement.setString(1,dataModelLibros.getTituloLibro());
            preparedStatement.setString(2,dataModelLibros.getEditorialLibro());
            preparedStatement.setInt(3,dataModelLibros.getLibroId());
     ...
     * 4. Cerrar conexión
     * */
    public static int eliminarElemento(DataModelLibros dataModelLibros){
        int fila = 0;
        try{
            Connection connection = DbConection.abrirConexion();
            PreparedStatement preparedStatement = connection.prepareStatement(DbQuerys.QUERYELIMINAR);

            preparedStatement.setInt(1,dataModelLibros.getLibroId());
            fila = preparedStatement.executeUpdate();
